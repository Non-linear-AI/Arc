...
- **[Examples](../examples/diabetes-prediction.md)** - More detailed tutorials
...
- **Escape Key**: Press `ESC` to interrupt long-running operations
- **Clear Context**: Use `/clear` to start fresh conversation
- **View Schema**: Use `/sql DESCRIBE table_name` to see table structure
...
If training fails:
1. Check your data has been loaded correctly (`/sql SHOW TABLES`)
2. Verify data table has the expected columns
3. Check console output for error messages

### API Key Issues

If you see authentication errors:
1. Run `/config` to verify your API key is set
...
1. Reduce batch size in the trainer config
2. Use a smaller dataset for testing
3. Close other applications

## Need Help?

- Read the [User Guides](../guides/data-loading.md)
- Check [GitHub Issues](https://github.com/non-linear-ai/arc/issues)
- Open a [new issue](https://github.com/non-linear-ai/arc/issues/new) with your question
